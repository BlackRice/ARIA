//#EditorFriendly
//#node13:posx=-183:posy=-101.5:title=Vector.W:input0=(0,0,0,0):input0type=Vector4:input0linkindexnode=5:input0linkindexoutput=0:
...
//#blending=Normal
//#ShaderName
Shader "ShaderFusion/SimpleSurface_twoSided_Transparent" {
	Properties {
