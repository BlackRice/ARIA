//#EditorFriendly
//#node28:posx=-854:posy=-117.5:title=TexWithXform:title2=Dif2:input0=(0,0):input0type=Vector2:input0linkindexnode=10:input0linkindexoutput=0:
//#node27:posx=-500:posy=-214:title=Texture:title2=SpecMap:input0=(0,0):input0type=Vector2:input0linkindexnode=23:input0linkindexoutput=0:
//#node26:posx=-864:posy=-36:title=Power:input0=0:input0type=float:input0linkindexnode=28:input0linkindexoutput=0:input1=0:input1type=float:input1linkindexnode=25:input1linkindexoutput=0:
//#node25:posx=-931:posy=50:title=ParamFloat:title2=Power:input0=1:input0type=float:
//#node24:posx=-913.5:posy=-212.5:title=ParamFloat:title2=UV1Tile:input0=1:input0type=float:
...
//#node17:posx=-676:posy=-116:title=Add:input0=0:input0type=float:input0linkindexnode=26:input0linkindexoutput=0:input1=0:input1type=float:input1linkindexnode=18:input1linkindexoutput=0:
...
//#node13:posx=-449:posy=1:title=ParamFloat:title2=Spec:input0=1:input0type=float:
...
//#node6:posx=-266:posy=2:title=Multiply:input0=1:input0type=float:input0linkindexnode=27:input0linkindexoutput=0:input1=1:input1type=float:input1linkindexnode=13:input1linkindexoutput=0:
...
//#blending=Normal
//#ShaderName
Shader "ShaderFusion/Shader_DualTextures_Simplified_withSpec" {
	Properties {
...
float4 node28 = tex2D(_Dif2,((((_L2_UV_Proportion) * (IN.sfuv1.xy)) * (1 / (_L2_UV_Tile))) + (_L2_UV_Offset)));
float4 node27 = tex2D(_SpecMap,((IN.sfuv1.xy) * (_UV1Tile)));
float4 node15 = tex2D(_Normal,((IN.sfuv1.xy) * (_UV1Tile)));
//#FragBody
normal = (float4(float3(UnpackNormal((node15))),0));
gloss = (_Gloss);
specular = ((node27) * (_Spec));
diffuse = ((node20) * (saturate(((pow((node28),(_Power))) + (_Dif2_Brightness)))));
