//#EditorFriendly
//#node13:posx=-520:posy=58.5:title=Texture:title2=Illum:input0=(0,0):input0type=Vector2:
//#node12:posx=-129:posy=-116:title=Multiply:input0=1:input0type=float:input0linkindexnode=11:input0linkindexoutput=0:input1=1:input1type=float:input1linkindexnode=5:input1linkindexoutput=0:
//#node11:posx=-221:posy=27:title=ParamFloat:title2=Specular:input0=1:input0type=float:
//#node10:posx=-367:posy=159:title=UnpackNormal:input0=0:input0type=float:input0linkindexnode=9:input0linkindexoutput=0:
//#node9:posx=-480:posy=161:title=Texture:title2=Normal:input0=(0,0):input0type=Vector2:
//#node8:posx=-144:posy=176:title=ParamFloat:title2=Glossiness:input0=1:input0type=float:
//#node7:posx=-325:posy=-26:title=Multiply:input0=1:input0type=float:input0linkindexnode=13:input0linkindexoutput=0:input1=1:input1type=float:input1linkindexnode=6:input1linkindexoutput=0:
//#node6:posx=-519:posy=-47:title=ParamFloat:title2=Brightness:input0=1:input0type=float:
...
//#masterNode:posx=0:posy=0:title=Master Node:input0linkindexnode=5:input0linkindexoutput=0:input1linkindexnode=7:input1linkindexoutput=0:input2linkindexnode=12:input2linkindexoutput=0:input3linkindexnode=8:input3linkindexoutput=0:input5linkindexnode=10:input5linkindexoutput=0:
//#sm=3.0
//#blending=Normal
//#ShaderName
Shader "ShaderFusion/shader_LightBulb_IlluminD" {
	Properties {
...
float4 node13 = tex2D(_Illum,IN.sfuv1.xy);
float4 node9 = tex2D(_Normal,IN.sfuv1.xy);
//#FragBody
normal = (float4(float3(UnpackNormal((node9))),0));
gloss = (_Glossiness);
specular = ((_Specular) * (node5));
emissive = ((node13) * (_Brightness));
diffuse = (node5);
