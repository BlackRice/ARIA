//#EditorFriendly
//#node16:posx=-246.5:posy=-101.5:title=ParamFloat:title2=Brightness:input0=1:input0type=float:
//#node15:posx=-136.5:posy=-142.5:title=Multiply:input0=1:input0type=float:input0linkindexnode=14:input0linkindexoutput=0:input1=1:input1type=float:input1linkindexnode=16:input1linkindexoutput=0:
//#node14:posx=-249.5:posy=-163.5:title=Multiply:input0=1:input0type=float:input0linkindexnode=5:input0linkindexoutput=0:input1=1:input1type=float:input1linkindexnode=13:input1linkindexoutput=0:
//#node13:posx=-363.5:posy=-154.5:title=VertexColor:
...
//#node5:posx=-337:posy=-217:title=TexWithXform:title2=MainTex:input0=(0,0):input0type=Vector2:
...
//#masterNode:posx=0:posy=0:title=Master Node:input0linkindexnode=15:input0linkindexoutput=0:input2linkindexnode=6:input2linkindexoutput=0:input3linkindexnode=12:input3linkindexoutput=0:input5linkindexnode=9:input5linkindexoutput=0:
//#sm=3.0
//#blending=Normal
//#ShaderName
Shader "ShaderFusion/SimpleSurfaceVertexColor" {
	Properties {
...
diffuse = (((node5) * (IN.COLOR)) * (_Brightness));
