...
//#node15:posx=-455:posy=60:title=Multiply:input0=1:input0type=float:input0linkindexnode=7:input0linkindexoutput=0:input1=1:input1type=float:input1linkindexnode=17:input1linkindexoutput=0:
//#node14:posx=-717:posy=19:title=Texture:title2=IllumMask:input0=(0,0):input0type=Vector2:
//#node13:posx=-129:posy=-116:title=Multiply:input0=1:input0type=float:input0linkindexnode=12:input0linkindexoutput=0:input1=1:input1type=float:input1linkindexnode=5:input1linkindexoutput=0:
//#node12:posx=-221:posy=27:title=ParamFloat:title2=Specular:input0=1:input0type=float:
...
//#node7:posx=-396:posy=-28:title=Multiply:input0=1:input0type=float:input0linkindexnode=5:input0linkindexoutput=0:input1=1:input1type=float:input1linkindexnode=6:input1linkindexoutput=0:
...
//#masterNode:posx=0:posy=0:title=Master Node:input0linkindexnode=5:input0linkindexoutput=0:input1linkindexnode=15:input1linkindexoutput=0:input2linkindexnode=13:input2linkindexoutput=0:input3linkindexnode=8:input3linkindexoutput=0:input4linkindexnode=9:input4linkindexoutput=0:input5linkindexnode=11:input5linkindexoutput=0:
//#sm=3.0
//#blending=Normal
//#ShaderName
Shader "ShaderFusion/shader_LightBulb_IlluminB" {
	Properties {
