...
//#node26:posx=-978:posy=35:title=ParamFloat:title2=Power:input0=1:input0type=float:
...
//#node22:posx=-1379:posy=-239:title=ParamVector:title2=L2_UV_Proportion:input0=(1,1,1,1):input0type=Vector4:
...
//#node12:posx=-1463:posy=-56:title=ParamFloat:title2=L2_UV_Tile:input0=1:input0type=float:
//#node11:posx=-1124:posy=-1:title=ParamVector:title2=L2_UV_Offset:input0=(0,0,0,0):input0type=Vector4:
...
//#node9:posx=-1344:posy=-58:title=Divide:input0=1:input0type=float:input1=1:input1type=float:input1linkindexnode=12:input1linkindexoutput=0:
//#node8:posx=-1094:posy=-125:title=Multiply:input0=1:input0type=float:input0linkindexnode=21:input0linkindexoutput=0:input1=1:input1type=float:input1linkindexnode=9:input1linkindexoutput=0:
//#node7:posx=-1376:posy=-152:title=UV1:
...
//#blending=Normal
//#ShaderName
Shader "ShaderFusion/Shader_DualTextures_Simplified" {
	Properties {
...
gloss = (_Gloss);
specular = (((node20) * (saturate(((pow((node25),(_Power))) + (_Dif2_Brightness))))) * (_Spec));
diffuse = ((node20) * (saturate(((pow((node25),(_Power))) + (_Dif2_Brightness)))));
