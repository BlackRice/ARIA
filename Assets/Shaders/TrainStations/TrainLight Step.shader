//#EditorFriendly
//#node25:posx=-17:posy=283:title=TexWithXform:title2=Alpha:input0=(0,0):input0type=Vector2:
...
//#masterNode:posx=0:posy=0:title=Master Node:input0linkindexnode=5:input0linkindexoutput=0:input1linkindexnode=16:input1linkindexoutput=0:input4linkindexnode=25:input4linkindexoutput=0:
//#sm=3.0
//#blending=Additive
//#ShaderName
Shader "ShaderFusion/TrainLight Step" {
	Properties {
...
float4 node25 = tex2D(_Alpha,IN.uv_Alpha.xy);
//#FragBody
alpha = (node25);
