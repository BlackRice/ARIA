//#EditorFriendly
//#node8:posx=-380:posy=42:title=UnpackNormal:input0=0:input0type=float:input0linkindexnode=7:input0linkindexoutput=0:
//#node7:posx=-531:posy=-38:title=Texture:title2=BumpMap:input0=(0,0):input0type=Vector2:
//#node6:posx=-240:posy=30:title=Reflection:input0=0:input0type=float:input1=0:input1type=float:input1linkindexnode=8:input1linkindexoutput=0:
//#node5:posx=-119:posy=29:title=CubeMap:title2=CubeMap1:input0=(0,0):input0type=Vector2:input0linkindexnode=6:input0linkindexoutput=0:
...
//#masterNode:posx=0:posy=0:title=Master Node:input1linkindexnode=5:input1linkindexoutput=0:
//#sm=3.0
//#blending=Normal
//#ShaderName
Shader "ShaderFusion/CubeMapTest" {
	Properties {
...
//#DeferredVertexEnd
		...
		void surf (Input IN, inout SurfaceShaderFusion o) {
			...
			float alpha = 1.0;
//#PreFragBody
float4 node7 = tex2D(_BumpMap,IN.sfuv1.xy);
float4 node5 = texCUBE(_CubeMap1,WorldReflectionVector(IN, ((float4(float3(UnpackNormal((node7))),0)))));
//#FragBody
emissive = (node5);
