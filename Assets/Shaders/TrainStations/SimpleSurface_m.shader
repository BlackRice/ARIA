...
//#node11:posx=-402:posy=-87:title=Texture:title2=Spec:input0=(0,0):input0type=Vector2:
//#node10:posx=-268:posy=181:title=TexWithXform:title2=BumpMap:input0=(0,0):input0type=Vector2:
...
//#node5:posx=-343:posy=-164:title=TexWithXform:title2=MainTex:input0=(0,0):input0type=Vector2:
...
//#blending=Normal
//#ShaderName
Shader "ShaderFusion/SimpleSurface_m" {
	Properties {
...
float4 node11 = tex2D(_Spec,IN.sfuv1.xy);
float4 node10 = tex2D(_BumpMap,IN.uv_BumpMap.xy);
//#FragBody
