//#EditorFriendly
//#node11:posx=-213:posy=22:title=Vector.W:input0=(0,0,0,0):input0type=Vector4:input0linkindexnode=5:input0linkindexoutput=0:
//#node10:posx=-309.5:posy=154.5:title=ParamFloat:title2=Glossiness:input0=1:input0type=float:
//#node9:posx=-299.5:posy=-43.5:title=Multiply:input0=1:input0type=float:input0linkindexnode=5:input0linkindexoutput=0:input1=1:input1type=float:input1linkindexnode=8:input1linkindexoutput=0:
//#node8:posx=-417.5:posy=-29.5:title=ParamFloat:title2=Specular:input0=1:input0type=float:
//#node7:posx=-300.5:posy=69.5:title=UnpackNormal:input0=0:input0type=float:input0linkindexnode=6:input0linkindexoutput=0:
//#node6:posx=-414.5:posy=70.5:title=TexWithXform:title2=Normal:input0=(0,0):input0type=Vector2:
//#node5:posx=-407.5:posy=-119.5:title=TexWithXform:title2=MainTex:input0=(0,0):input0type=Vector2:
...
//#masterNode:posx=0:posy=0:title=Master Node:input0linkindexnode=5:input0linkindexoutput=0:input2linkindexnode=9:input2linkindexoutput=0:input3linkindexnode=10:input3linkindexoutput=0:input4linkindexnode=11:input4linkindexoutput=0:input5linkindexnode=7:input5linkindexoutput=0:
//#sm=3.0
//#blending=Normal
//#ShaderName
Shader "ShaderFusion/shader_Hao_SimpleAlpha" {
	Properties {
...
float4 node6 = tex2D(_Normal,IN.uv_Normal.xy);
//#FragBody
normal = (float4(float3(UnpackNormal((node6))),0));
alpha = ((node5).w);
gloss = (_Glossiness);
specular = ((node5) * (_Specular));
diffuse = (node5);
