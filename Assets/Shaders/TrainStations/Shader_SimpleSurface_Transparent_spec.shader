//#EditorFriendly
//#node13:posx=-587:posy=106.5:title=Texture:title2=Spec:input0=(0,0):input0type=Vector2:
//#node12:posx=-303:posy=145.5:title=Multiply:input0=1:input0type=float:input0linkindexnode=13:input0linkindexoutput=0:input1=1:input1type=float:input1linkindexnode=11:input1linkindexoutput=0:
//#node11:posx=-451:posy=122.5:title=ParamFloat:title2=Glosiness:input0=1:input0type=float:
//#node10:posx=-497:posy=39.5:title=ParamFloat:title2=Specular:input0=1:input0type=float:
//#node9:posx=-324:posy=54.5:title=Multiply:input0=1:input0type=float:input0linkindexnode=13:input0linkindexoutput=0:input1=1:input1type=float:input1linkindexnode=10:input1linkindexoutput=0:
//#node8:posx=-411:posy=251.5:title=UnpackNormal:input0=0:input0type=float:input0linkindexnode=6:input0linkindexoutput=0:
//#node7:posx=-440:posy=-29.5:title=Vector.W:input0=(0,0,0,0):input0type=Vector4:input0linkindexnode=5:input0linkindexoutput=0:
//#node6:posx=-533:posy=248.5:title=Texture:title2=Normal:input0=(0,0):input0type=Vector2:
//#node5:posx=-531:posy=-60.5:title=Texture:title2=MainTex:input0=(0,0):input0type=Vector2:
...
//#masterNode:posx=0:posy=0:title=Master Node:input0linkindexnode=5:input0linkindexoutput=0:input2linkindexnode=9:input2linkindexoutput=0:input3linkindexnode=12:input3linkindexoutput=0:input4linkindexnode=7:input4linkindexoutput=0:input5linkindexnode=8:input5linkindexoutput=0:
//#sm=3.0
//#blending=Alpha
//#ShaderName
Shader "ShaderFusion/Shader_SimpleSurface_Transparent_spec" {
	Properties {
...
float4 node13 = tex2D(_Spec,IN.sfuv1.xy);
float4 node6 = tex2D(_Normal,IN.sfuv1.xy);
//#FragBody
normal = (float4(float3(UnpackNormal((node6))),0));
alpha = ((node5).w);
gloss = ((node13) * (_Glosiness));
specular = ((node13) * (_Specular));
diffuse = (node5);
