//#EditorFriendly
//#node13:posx=-202:posy=-106.5:title=TexWithXform:title2=alpha:input0=(0,0):input0type=Vector2:
...
//#node5:posx=-193:posy=-166:title=TexWithXform:title2=MainTex:input0=(0,0):input0type=Vector2:
//#node4:posx=0:posy=0:title=Lighting:title2=On:
//#node3:posx=0:posy=0:title=DoubleSided:title2=Off:
//#node2:posx=0:posy=0:title=FallbackInfo:title2=Transparent/Cutout/Diffuse:input0=1:input0type=float:
//#node1:posx=0:posy=0:title=LODInfo:title2=LODInfo1:input0=600:input0type=float:
//#masterNode:posx=0:posy=0:title=Master Node:input0linkindexnode=5:input0linkindexoutput=0:input2linkindexnode=6:input2linkindexoutput=0:input3linkindexnode=12:input3linkindexoutput=0:input4linkindexnode=13:input4linkindexoutput=0:input5linkindexnode=9:input5linkindexoutput=0:
//#sm=3.0
//#blending=Normal
//#ShaderName
Shader "ShaderFusion/SimpleSurface_twoSided_alphaMask" {
	Properties {
...
float4 node13 = tex2D(_alpha,IN.uv_alpha.xy);
