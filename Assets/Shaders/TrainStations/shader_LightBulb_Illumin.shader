...
//#node7:posx=-315:posy=-24:title=Multiply:input0=1:input0type=float:input0linkindexnode=5:input0linkindexoutput=0:input1=1:input1type=float:input1linkindexnode=6:input1linkindexoutput=0:
//#node6:posx=-484:posy=-28:title=ParamFloat:title2=Brightness:input0=1:input0type=float:
...
//#masterNode:posx=0:posy=0:title=Master Node:input0linkindexnode=5:input0linkindexoutput=0:input1linkindexnode=7:input1linkindexoutput=0:input2linkindexnode=13:input2linkindexoutput=0:input3linkindexnode=8:input3linkindexoutput=0:input4linkindexnode=9:input4linkindexoutput=0:input5linkindexnode=11:input5linkindexoutput=0:
//#sm=3.0
//#blending=Normal
//#ShaderName
Shader "ShaderFusion/shader_LightBulb_Illumin" {
	Properties {
