//#EditorFriendly
//#node7:posx=-160:posy=-118:title=Number:input0=0.3:input0type=float:
//#node6:posx=-252:posy=42:title=Reflection:input0=0:input0type=float:input1=0:input1type=float:
//#node5:posx=-131:posy=35:title=CubeMap:title2=CubeMap1:input0=(0,0):input0type=Vector2:input0linkindexnode=6:input0linkindexoutput=0:
...
//#node1:posx=0:posy=0:title=LODInfo:title2=LODInfo1:input0=500:input0type=float:
//#masterNode:posx=0:posy=0:title=Master Node:input0linkindexnode=5:input0linkindexoutput=0:input2linkindexnode=7:input2linkindexoutput=0:
//#sm=3.0
//#blending=Alpha
//#ShaderName
Shader "ShaderFusion/Shader_Transparent_Glass_Ref" {
	Properties {
...
//#DeferredVertexEnd
		...
		void surf (Input IN, inout SurfaceShaderFusion o) {
			...
			float alpha = 1.0;
//#PreFragBody
float4 node5 = texCUBE(_CubeMap1,WorldReflectionVector(IN, (normal)));
//#FragBody
specular = (0.3);
diffuse = (node5);
