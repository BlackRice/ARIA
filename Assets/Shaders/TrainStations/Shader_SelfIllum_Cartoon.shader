//#EditorFriendly
//#node6:posx=-307:posy=18:title=Texture:title2=Black:input0=(0,0):input0type=Vector2:
//#node5:posx=-308:posy=-49:title=Texture:title2=Main:input0=(0,0):input0type=Vector2:
...
//#masterNode:posx=0:posy=0:title=Master Node:input0linkindexnode=6:input0linkindexoutput=0:input1linkindexnode=5:input1linkindexoutput=0:
//#sm=3.0
//#blending=Normal
//#ShaderName
Shader "ShaderFusion/Shader_SelfIllum_Cartoon" {
	Properties {
...
//#DeferredVertexEnd
		...
		void surf (Input IN, inout SurfaceShaderFusion o) {
			...
			float alpha = 1.0;
//#PreFragBody
float4 node6 = tex2D(_Black,IN.sfuv1.xy);
